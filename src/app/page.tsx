      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 mb-8">
            สร้าง web แอปพลิเคชันด้วย Next.js, TypeScript, Tailwind CSS และ
            shadcn/ui
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <p className="text-slate-600">
                Next.js 16
                มาพร้อมกับฟีเจอร์ใหม่ที่ช่วยเพิ่มประสิทธิภาพให้เว็บแอปพลิเคชันของคุณโหลดได้รวดเร็วขึ้นและตอบสนองได้ดีขึ้น
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-slate-600">
                สร้าง UI ที่สวยงามและ responsive ได้อย่างรวดเร็วด้วย
                utility-first CSS
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-slate-600">
                shadcn/ui ให้คุณ copy โค้ดมาใช้
                ทำให้ปรับแต่งได้ตามต้องการอย่างเต็มที่
              </p>
            </CardContent>
          </Card>
        </div>
